...
/*! 
    ...
    THIS PROGRAM HAS BEEN MODIFIED TO WRITE item_id TO NFC TAGS
    PLACED ON 3DS ITEMS DESIGNATED TO GO TO MARKETING EVENTS
    INITIATED BY AND CHANNELED THROUGH THE 3DSYSTEMS NEW YORK OFFICE
...
*/
// For a http://www. url:
const char * item_id = "item_id"; //this is where the item_id in our cataloging system will be written to the NFC tags
...
void loop(void) {
  ...
  if (success) 
  {
    ...
    success = nfc.mifareclassic_WriteNDEFURI(1, ndefprefix, item_id);
    if (success)
    {
